  ...
  <div class="view">
    <Panel :title="$t('m.User_User') ">
      ...
      <el-table
        ...
        <el-table-column prop="is_approved" label="Approved" width="100">
          <template slot-scope="scope">
            <el-tag :type="scope.row.is_approved ? 'success' : 'danger'" size="small">
              {{ scope.row.is_approved ? 'Yes' : 'No' }}
            </el-tag>
          </template>
        </el-table-column>
    ...
    <el-dialog :title="$t('m.User_Info')" :visible.sync="showUserDialog" :close-on-click-modal="false">
      <el-form :model="user" label-width="120px" label-position="left">
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <el-form-item label="Is Approved">
              <el-switch
