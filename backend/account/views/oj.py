...
class UserRegisterAPI(APIView):
    ...
    def post(self, request):
        ...
        # New users need admin approval before accessing problems
        user.is_approved = False
        user.save()
        UserProfile.objects.create(user=user)
        return self.success("Registration successful. Please wait for admin approval before accessing problems.")
